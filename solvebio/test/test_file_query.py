# FIXME: the tests should be uncommented when file-based query functionality
#  has been deployed to production, otherwise they are going to fail,
#  as we use the prod API for building python client code!!!!
